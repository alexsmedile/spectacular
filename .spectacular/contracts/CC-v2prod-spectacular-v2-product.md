...
operating_cases:
  - Cold project orientation, Mission resume, governed execution, assessment, reconciliation, and closure.
persistent_information:
  - Anchors, Contracts, Proposals, Missions, Evidence, Decisions, Gaps, and continuity boundaries.
conformance_checks:
...
authority_freshness: Exact owner Decision and current source fingerprints are required for consequential mutation.
related_material:
