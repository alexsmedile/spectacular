...
Areas in current order: `skill`, `workspace`, `frontmatter`, `snapshots`, `links`, `lifecycle`, `kits`, `conventions`, `specs`, `docs`, `personas`, `memory`, `sessions`, `feedback`, `ideas`, `wayfinding`, `debug`, `policies`, `vision`, `decisions`, `roadmap`.
