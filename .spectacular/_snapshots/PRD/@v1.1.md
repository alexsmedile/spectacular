...
version: 1.1
updated: 2026-05-11
summary: "Continuity placeholder — v1.1 version bump was skipped during canonical-docs-rework"
note: "This snapshot exists solely to maintain version-sequence continuity. Content mirrors PRD@v1.0.md (the actual state during the v1.0→v1.2 transition). No real v1.1 was ever produced — the version bump was skipped. See DECISIONS.md (2026-05-22 entry) for full context."
---

# Spectacular — Product Requirements Document (continuity placeholder for v1.1)
