...
func workspaceGuide(rows []indexRow) []byte {
	...
	text.WriteString("Compact routing only. Read canonical sources for authority; [.cache/catalog.json](.cache/catalog.json) is the complete record inventory.\n\n")
