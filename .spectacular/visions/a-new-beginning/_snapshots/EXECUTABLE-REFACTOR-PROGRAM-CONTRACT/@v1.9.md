...
version: 1.9
status: accepted
decision_session: b-c-central-acceptance
source_handoff: b-c-final-independent-review
accepted_by: owner
accepted_at: 2026-08-10
central_disposition: accept
supersedes: _snapshots/EXECUTABLE-REFACTOR-PROGRAM-CONTRACT/@v1.8.md
upstream:
...
next_action: prepare-skill-and-runtime-prerequisites-mission
---
...
This v1.9 program accepts the complete B+C governed loop after independent review, preserves the
minimal-agent execution default, and makes the separate Skill/runtime-prerequisites Mission the
only next-ready program step. No successor Mission is activated by this record.
...
W0 shared-scaffold gate — accepted
  ...
  → S Skill and runtime prerequisites — next-ready for preparation
...
Prepare the separate Skill and runtime-prerequisites Mission. Reuse accepted workflow, authority,
retrieval, public-language, and B+C mechanics; do not reopen them. Ask the owner only if a new
Type-1 product, authority, safety, or irreversible-effect decision survives a short gap audit. Do
not activate the Mission merely by updating this program.
