...
| Campaign | Optional durable roadmap map in `.spectacular/campaigns/` (synonyms: *Initiative*, *Milestone Arc*, *Flight Plan*, *Theme*); aim for 4–10 topological Campaign Blocks, split an unwieldy map, visualize it when helpful, never execution authority |
