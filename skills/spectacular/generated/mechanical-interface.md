...
| `spectacular objective show` | `<ref> [--json]` | `spectacular.objective.show.v1` | `read-only` |
| `spectacular assessment show` | `<ref> [--json]` | `spectacular.assessment.show.v1` | `read-only` |
